...
type ObjectAlignGuide = { axis: 'y'; position: number };
...
export function DndPage() {
  ...
  const onDragMove = (event: DragMoveEvent) => {
    ...
    setObjectAlignGuides(uniqueGuideYs.map((position) => ({ axis: 'y' as const, position })));
  };
                    ...
                    >
                      ...
                      {objectAlignGuides.map((guide) => (
                        <div
                          ...
                          className="dnd-object-align-guide dnd-object-align-guide-horizontal"
